                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header text-center">
                            <h5 class="card-title">Edit News Article</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ $news->title }}" required>
                                        @error('title')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" name="date" id="date" class="form-control @error('date') is-invalid @enderror" value="{{ $news->date }}" required>
                                        @error('date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" class="description ckeditor form-control" name="wysiwyg-editor">{{ $news->content }}</textarea>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="file" name="required_image" id="required_image" class="form-control-file @error('required_image') is-invalid @enderror" accept="image/*">
